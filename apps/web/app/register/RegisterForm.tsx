...
export function RegisterForm() {
  ...
  // 1. READ URL ERROR PARAMS HERE
  const searchParams = useSearchParams();
  const urlError = searchParams.get("error");

  const ERROR_MESSAGES: Record<string, string> = {
    verification_failed: "Verification link is invalid or has expired. Please register again.",
    setup_failed: "Account was verified but restaurant setup failed. Contact support.",
    missing_data: "Something went wrong during setup. Please register again.",
  };
  ...
  return (
    <>
      {/* 2. DISPLAY URL ERROR MESSAGES ABOVE THE FORM */}
      {urlError && ERROR_MESSAGES[urlError] && (
        <div className="mb-4 rounded-lg px-4 py-3 text-sm bg-red-50 text-red-700 border border-red-100">
