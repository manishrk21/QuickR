...
{/* 
      ...
      {/* ── QUICKR JOURNEY (real product screenshots) ─────────────────────── */}
      {/*
          Mirrors the dashboard section above: real menu screenshot on the
          left, a scannable QR on the right that takes the visitor straight
          into a live sample menu on their own phone.
